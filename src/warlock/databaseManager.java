...
public final class databaseManager {
     ...
     * libraries.
     */
    private static final String USER_NAME = "warlock"; //your DB username
    private static final String PASSWORD = "warlock"; //your DB password
    private static final String URL = "jdbc:derby:warlockDB; create=true";  //url of the DB host
